...
#FPAC with random initialization
CLUSTER_METHOD=fpac_true_centroid
...
$JAVA_HOME/bin/java -Xmx8G -cp $CP clusterer.FastKMedoidsClusterer_TrueCentroid $PROPFILE > $LOGFILE 2>&1
